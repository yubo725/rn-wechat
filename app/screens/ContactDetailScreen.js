...
export default class ContactDetailScreen extends Component {
      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            ...
            <Text style={{ fontSize: 17, color: "#999999", marginTop: 5 }}>
              点击屏幕重试
            </Text>
          </View>
        </TouchableOpacity>
        ...
        <ScrollView>
          <View style={styles.content}>
            <View style={styles.contactInfoContainer}>
              ...
              <ImageAdapter path={this.userInfo.icon} width={65} height={65} />
              <View style={styles.contactInfoTextContainer}>
                <Text style={styles.contactNameText}>
                  {this.userInfo.title}
                </Text>
                <Text style={styles.conatactNickNameText}>
              ...
              <View>
                ...
                >
                  <View style={styles.deleteBtn}>
                    <Text style={styles.positiveBtnText}>删除好友</Text>
                  </View>
                </TouchableOpacity>
              </View>
            )}
          ...
          >
            <ConfirmDialog
              ...
              leftBtnText="确定"
              rightBtnText="取消"
              leftBtnClick={this._confirmDeleteFriend}
            />
          </View>
        </ScrollView>
      </View>
  ...
  _confirmDeleteFriend = () => {
    JMessage.removeFromFriendList(
      {
        username: this.userInfo.title,
        appKey: Global.JIMAppKey
      },
      () => {
        Toast.showShortCenter("删除好友成功");
        // 通知好友列表刷新
        CountEmitter.emit("refreshFriendList");
      },
      error => {
        Toast.showShortCenter("删除好友失败：" + error.description);
      }
    );
  };
