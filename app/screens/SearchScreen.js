        ...
        <View style={styles.content}>
          ...
          <View style={styles.row}>
            <View style={styles.rowItem}>
              <Text style={styles.rowItemText}>朋友圈</Text>
            </View>
            <View style={styles.rowItemDivider} />
            <View style={styles.rowItem}>
              <Text style={styles.rowItemText}>文章</Text>
            </View>
            <View style={styles.rowItemDivider} />
            <View style={styles.rowItem}>
              <Text style={styles.rowItemText}>公众号</Text>
            </View>
          </View>
          <View style={styles.row}>
            <View style={styles.rowItem}>
              <Text style={styles.rowItemText}>小说</Text>
            </View>
            <View style={styles.rowItemDivider} />
            <View style={styles.rowItem}>
              <Text style={styles.rowItemText}>音乐</Text>
            </View>
            <View style={styles.rowItemDivider} />
            <View style={styles.rowItem}>
              <Text style={styles.rowItemText}>表情</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View key={item.item.key}>
        ...
        >
          <View style={listItemStyle.container}>
            <Image
              style={listItemStyle.listItemAvatar}
