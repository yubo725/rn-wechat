...
export default class PublishMomentScreen extends Component {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomContent}>
          <View style={styles.bottomItem}>
            <Image
              style={styles.bottomItemIcon}
              source={require("../../images/ic_earth.png")}
            />
            <Text>谁可以看</Text>
          </View>
          <View
            style={{ width: width, height: 1, backgroundColor: "#EBEBEB" }}
          />
          <View style={styles.bottomItem}>
            <Image
              style={styles.bottomItemIcon}
              source={require("../../images/ic_at.png")}
            />
            <Text>提醒谁看</Text>
          </View>
        </View>
  ...
  sendMoment() {
    ...
    let url = Api.PUBLISH_MOMENT_URL;
  ...
  renderAddBtn() {
    return (
      ...
      >
        <Image
          source={require("../../images/ic_add_pics.png")}
